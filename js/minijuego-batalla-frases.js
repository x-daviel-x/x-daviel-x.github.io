...
const questionTime = 20; // Tiempo por pregunta en segundos
let countdownTimer;
let questions = [
    {
...
function showNextQuestion() {
    ...
    if (currentQuestionIndex < maxQuestions && currentQuestionIndex < questions.length) {
        ...
        questionText.innerHTML = pregunta.frase  + "<br>" + pregunta.pregunta;
...
function startCountdown() {
    ...
    countdownTimer = setInterval(() => {
        ...
        if (currentQuestionIndex === 0 && timeLeft === (questionTime - 10)) {
...
function handleTimeout() {
    ...
    const pregunta = questions[currentQuestionIndex];
    const selectedButton = optionButtons[pregunta.respuestaCorrecta - 1];
